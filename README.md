...
|---                |---                |
| data              | Raw data. Includes Reddit, Twitter, Yahoo Finance, Options, and logs |
| data_processing   | Code for data processing and extraction                              |
| processed_data    | Processed data from raw data (Includes only Reddit) generated by scripts |
